...
namespace UECda{
    namespace Fuji{
        ...
        public:
            ...
            int startChange(Field *const, int, Cards, sharedData_t *const, threadTools_t *const);
            
            template<int M = 0, class sharedData_t, class threadTools_t>
            int startAll(Field *const, sharedData_t *const, threadTools_t *const);
            
            template<int M = 0, class sharedData_t, class threadTools_t>
            int startRoot(Field *const, sharedData_t *const, threadTools_t *const);
            
            template<int M = 0, class sharedData_t, class threadTools_t>
            int startRoot(Field *const, MoveInfo, sharedData_t *const, threadTools_t *const);
        ...
        int Playouter::startRoot(Field *const pfield,
        ...
        template<int M, class sharedData_t, class threadTools_t>
        int Playouter::startChange(Field *const pfield,
                                   int p, Cards c,
                                   sharedData_t *const pshared,
                                   threadTools_t *const ptools){
        ...
        template<int M, class sharedData_t, class threadTools_t>
        int Playouter::startAll(Field *const pfield,
                                sharedData_t *const pshared,
                                threadTools_t *const ptools){
