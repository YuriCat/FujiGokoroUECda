...
#ifndef UECDA_LOGIC_APPLIEDLOGIC_HPP_
#define UECDA_LOGIC_APPLIEDLOGIC_HPP_
...
namespace UECda{
    ...
    static inline Cards getAllNFHCards(const Cards mine, const Cards ops,
        ...
        if(containsS3(ret)){
            if(containsJOKER(addCards(mine, ops))){
                subtrCards(&ret, CARDS_S3);
            }
        }
        return ret;
    }
...
#endif // UECDA_LOGIC_APPLIEDLOGIC_HPP_
