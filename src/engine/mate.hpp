...
extern bool judgeHandMate(const int depth, MoveInfo *const mbuf,
                          const Hand& myHand, const Hand& opsHand,
                          const Board& b, const FieldAddInfo& fieldInfo);
extern bool checkHandMate(const int depth, MoveInfo *const mbuf, MoveInfo& m,
                          const Hand& myHand, const Hand& opsHand,
                          const Board& b, const FieldAddInfo& fieldInfo);
extern int searchHandMate(const int depth, MoveInfo *const mbuf, int numMoves,
                          const Hand& myHand, const Hand& opsHand,
                          const Board& b, const FieldAddInfo& fieldInfo);