...
namespace UECda{
    ...
    struct Field{
        ...
        void setInChange()noexcept{ phase.setInChange(); }
        void resetInChange()noexcept{ phase.resetInChange(); }
        void setSubjective()noexcept{ phase.setSubjective(); }
        
        bool isInitGame()const noexcept{ return phase.isInitGame(); }
        bool isInChange()const noexcept{ return phase.isInChange(); }
        bool isSubjective()const noexcept{ return phase.isSubjective(); }
        ...
        void setPlayerClass(int p, int cl)noexcept{
            infoClass.set(p, cl);
            infoClassPlayer.set(cl, p);
        }
        void setPlayerNewClass(int p, int c)noexcept{
            infoNewClass.set(p, c);
            infoNewClassPlayer.set(c, p);
        }
        void setPlayerSeat(int p, int s)noexcept{
            infoSeat.set(p, s);
        ...
        // ハッシュ値更新
        void procBoardStateDead(int p)noexcept{
...
#undef Foo
    ...
    int Field::proc(const int tp, const MoveInfo mv)noexcept{
        // 丁寧に局面更新
    ...
    int Field::proc(const int tp, const Move mv)noexcept{
        return proc(tp, (MoveInfo)mv);
    }
    
    int Field::procSlowest(const Move mv)noexcept{
    ...
    int Field::procSlowest(const MoveInfo mv)noexcept{
    ...
    /*template<class wField_t, class addField_t>
     void convField(const wField_t& wField, const addField_t& addField, Field *const dst)noexcept{
    ...
    void copyField(const Field& arg, Field *const dst)noexcept{
    ...
    void setSubjectiveField(const sbjField_t& arg, Field *const dst)noexcept{
    ...
    void setSubjectiveField(const sbjField_t& arg, const policy_t& pol, Field *const dst)noexcept{
    ...
    void setWorld(const sbjField_t& field, const world_t& world, Field *const dst)noexcept{
    ...
    void setWorld(const sbjField_t& field, const world_t& world, const policy_t& pol, Field *const dst)noexcept{
